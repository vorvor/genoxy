 ...
 */
function genoxy_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['genoxy_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('genoxy sample setting'),
  '#default_value' => theme_get_setting('genoxy_example'),
